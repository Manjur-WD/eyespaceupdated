  ...
  $('.cat-nav').on('click', function(e) {
      ...
      switch(contentType) {
          ...
          case 'Night Vision Lens':
              ...
              content = 'Night vision glasses are <span class="bg-warning">a type of eyeglass that improve night vision, used especially as driving glasses.</span>  These night glasses are coated in yellow-tinted, anti-reflective material, and may also be polarized to improve vision at night.';
              break;
          case 'Drive Safe Lens':
              title = '<h5>Drive Safe Lens :</h5>';
              content = 'These lenses help you enjoy better vision in all weather and light conditions, protect your eyes from perceived glare and make it easier for you to shift your viewing focus from sat nav and rear-view mirror to windscreen – quickly and often.';
              break;
          case 'Myopia Control Lens':
              title = '<h5>Myopia Control Lens :</h5>';
              content = 'Myopia control spectacles and contact lenses are <span class="bg-warning">designed to focus peripheral light rays in front of the retina, to act as a stop signal to encourage slower eye growth and slow progression of myopia.</span>';
              break;
          case 'Customized Progressive lens':
              title = '<h5>Customized Progressive lens :</h5>';
              content = 'With lesser amount of peripheral distortions and wider field of view, there will be lesser amount of head movement when you want to have sharp vision. Your vision will also be more natural looking through the lenses. Hence, with customized progressive, you will be able to adapt faster as compared to standard progressive.';
              break;
          case 'Double Aspheric Lenses':
              title = '<h5>Double Aspheric Lenses :</h5>';
              content = 'Double aspheric lenses <span class="bg-warning">use irregular curvatures on both their front and rear surfaces to make them thinner in profile, lighter in weight and aesthetically flatter.</span> These lenses are popular for strong prescriptions to reduce thickness at their centers or edges.';
              break;
          case 'Prism Lenses':
              title = '<h5>Prism Lenses :</h5>';
              content = 'A prism added to eyeglasses bends light before it travels through the eye. The light is redirected to the right place on the retina in each eye. The brain then fuses the two images together to produce one, clear picture.';
              break;
